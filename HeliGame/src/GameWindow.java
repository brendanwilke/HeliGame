 ...
 * 
 * HelicopterGame handles all the timing of the animation to attempt
 ...
 * 
 * Modify line 122 to load a specific game...
 * 
 * 
 * </pre>
 */
public class GameWindow extends JFrame implements Runnable {
  ...
  // /////////////////////////////////////////////////////////
  /**
   * Constructor takes a long number of frames per second which corresponds to the
   * somewhat guaranteed updates per second.<br>
   */
  public GameWindow(long fps) {
    super("HelicopterGame");
    ...
    curGame = new HeliGame(this);

    animationStart();
  } // end of GameWindow(int fps) constructor
  ...
  /**
   * Returns the Graphics2D for individual games
   */
  ...
  private void initFullScreen() {
    ...
    // hide mouse cursor
    Toolkit tk = Toolkit.getDefaultToolkit();
    setCursor(tk.createCustomCursor(new BufferedImage(32, 32, BufferedImage.TYPE_4BYTE_ABGR), new Point(0, 0), ""));
